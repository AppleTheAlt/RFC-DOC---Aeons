...
iMadagascar :		(89, 18), # Antananarivo (Alasora)
iFunj :			(80, 34), # Sennar
iAdal :			(86, 34), # Adal
iSomalia :		(87, 29), # Mogadishu
iBuganda :		(80, 29), # Lubaga
iKatanga :		(76, 24), # Mwibele
iZimbabwe :		(79, 17), # Zimbabwe
iSouthAfrica :		(72, 11), # Kaapstad (Cape Town)
iBoers :		(78, 15), # Pretoria (KwaMnyamana)
iZulu :			(79, 13), # kwaBulawayo (Durban)
iAshanti :		(61, 32), # Kumasi
iHausa :		(66, 36), # Katsina
iBenin :		(66, 32), # Edo/Benin
iKanemBornu :		(71, 36), # Njimi
iSonghai :		(63, 36), # Gao
iGhana :		(58, 37), # Kombi Saleh
iKhazars:       	(90, 59), # Atil / Itil
iGhorids:      		(99, 49), # Ghazni
iGeorgia : 		(89, 55), # Mtskheta
iJerusalem : 		(84, 45), # Jerusalem
iOman : 		(96, 40), # Muscat
iYemen :		(89, 35), # Aden
iTunis : 		(67, 48), # Tunis (Carthage)
iGokturks :		(119, 61), # Otuken (QaraKorum)
iSamanids : 		(100, 55), # Samarkand
iBuyids :		(94, 45), # Persepolis
iMisr : 		(67, 48), # Raqqada (Carthage)
iParthia : 		(96, 52), # Asaak
iArmenia : 		(89, 53), # Artashat
iScythia : 		(97, 53), # Merv
iNumidia : 		(60, 47), # Shigan
iVandals :		(71, 62), # Wroclaw
iHuns :			(83, 59), # Eupatoria
iGoths :		(73, 65), # Danzig
iGermania :		(64, 62), # Cologne
iMacedon :		(76, 54), # Pella
iMycenae :		(75, 50), # Mycenae
iSparta :		(75, 49), # Sparta
iElam :      (92, 46), # Susa 
iSumeria :      (90, 45), # Ur    
iMinoa : 	(78, 48), # Knossos
iJudah : 	(84, 45), # Jerusalem
...
iPeriodVandalAfrica : 		(67, 48),	# Carthage
iPeriodOstrogoths : 		(68, 53),	# Rome
iPeriodVisigoths : 		(57, 52),	# Madrid
iPeriodMughals : 		(105, 46),  # Delhi
iPeriodCastile : 		(57, 51),	# Madrid
iPeriodModernSpain : 		(57, 51),	# Madrid
iPeriodDelhi:			(105, 46),  # Delhi
iPeriodUkraine :		(81, 62), # Kyiv
iPeriodZanzibar :		(85, 25), # Zanzibar
}
...
iGhorids:       	((95, 43),      (100, 51)),
iTimurids:      	((96, 52),	(102, 58)),
iJerusalem :		((83, 43),	(85, 49)),
iGokturks :		((104, 54),	(120, 63)),
iMisr :		((64, 44),	(71, 49)),
iParthia : 		((93, 51),	(96, 54)),
iNumidia :		((60, 45),	(61, 48)),
...
iSouthAfrica :		[(79, 14), (79, 13)],
iSpain :		[(62, 54)],
iIndia :		[(105, 43), (106, 43), (107, 43), (108, 43), (109, 43), (110, 43), (111, 46), (112, 46)],
iPersia :		[(91, 45)],
iCelts :		[(64, 60), (64, 61), (65, 58), (65, 59), (65, 60), (65, 61), (66, 58), (66, 59), (66, 60), (66, 61), (67, 55), (67, 56), (67, 58), (67, 59), (67, 60), (67, 61)],
iKushans :		[(96, 47), (96, 48), (96, 49), (96, 50), (96, 51), (97, 47), (97, 48), (97, 49), (97, 50), (97, 51), (103, 52), (103, 53), (103, 54), (103, 55)],
iKorea :		[(130, 58)],
iByzantium :	[(73, 57), (74, 57), (75, 57), (76, 57), (77, 57), (83, 51), (84, 51), (84, 52), (85, 48), (85, 49), (85, 50), (85, 51), (85, 52), (86, 48), (86, 49), (86, 50), (86, 51), (86, 52), (86, 53), (87, 48), (87, 49), (87, 50), (87, 51), (87, 52), (87, 53), (87, 57)],
iFrance :		[(64, 63)],
...
dCoreArea = CivDict({
iMorocco :		((56, 42),  	(59, 47)),
iMadagascar :		((88, 15), 	(91, 20)),
iFunj :			((80, 34), 	(81, 37)), 
iAdal :			((85, 32),	(86, 35)),
iSomalia :		((87, 29), 	(89, 33)),
iBuganda :		((79, 29), 	(81, 30)),
iKatanga :		((76, 23),	(77, 26)),
iZimbabwe :		((78, 16), 	(79, 18)),
iSouthAfrica :		((72, 11), 	(77, 12)),
iBoers :		((73, 11), 	(78, 15)),
iZulu :			((78, 12), 	(79, 13)),
iAshanti :		((61, 31),	(62, 34)),
iHausa :		((64, 34),	(67, 37)),
iBenin :		((65, 31),	(66, 32)),
iKanemBornu:		((69, 34),	(71, 37)),
iSonghai:		((60, 36),	(63, 38)),
iGhana:			((57, 35),	(59, 38)),
iKhazars:      	 	((86, 57),  	(92, 61)),
iGhorids:       	((96, 46),      (100, 51)),
iGeorgia : 		((88, 55),	(89, 56)),
iJerusalem :		((83, 44),	(84, 45)),
iOman: 			((94, 39), 	(96, 41)),
iYemen:			((87, 35), 	(91, 37)),
iTunis:			((67, 45),	(70, 48)),
iGokturks :		((115, 56),	(120, 61)),
iSamanids :		((96, 52),	(100, 55)),
iBuyids :		((92, 43),	(94, 48)),
iMisr :		((65, 44),	(70, 49)),
iParthia :		((92, 45),	(97, 53)),
iArmenia : 		((88, 52),	(90, 54)),
iScythia :		((92, 52),	(101, 56)),	
iNumidia:		((60, 45),	(65, 48)),
iVandals :		((69, 60),	(72, 62)),
iHuns :			((80, 58),	(84, 62)),
iGoths :		((73, 59),	(77, 66)),
iGermania :		((62, 61),	(68, 65)),
iMacedon :		((75, 53),	(77, 56)),
iSparta :		((74, 49),	(75, 50)),
iMycenae :		((74, 49),	(76, 52)),
iElam :			((91, 44),	(93, 46)),
iSumeria :		((89, 45),	(90, 46)),
iJudah :		((83, 44),	(85, 45)),
iMinoa :		((77, 48),	(78, 48)),
iEgypt :		((78, 41),	(80, 44)),
...
iFunj :		[(80, 37)],
iSomalia :	[(87, 30), (87, 31), (87, 32)],
iSouthAfrica :	[(77, 14)],
iBoers :	[(73, 13), (73, 14), (73, 15), (74, 13), (74, 14), (74, 15), (75, 13), (75, 14), (75, 16), (75, 15), (76, 13), (76, 14), (76, 15)],
iArabia :	[(87, 43),(87, 42),(87, 41),(86, 43)],
iSonghai :	[(60, 36),(60, 37)],
iTunis :	[(70, 48)],
iGoths :	[(74, 69),(76, 66),(77, 66),(77, 65),(77, 64),(77, 63),(77, 64),(76, 66),(76, 65),(76, 64),],
iGermania :	[(62, 61),(63, 61),(62, 62),(63, 62),(68, 60),(68, 59),(67, 60),(67, 59),(66, 60),(66, 59),(65, 60),(65, 59)],
iEgypt :	[(80, 43), (80, 44)],
iBabylonia: [(88, 45)],
iHarappa :	[(102, 46)],
...
iPeriodUganda :						((79, 29), 	(81, 30)),
iPeriodBuganda :					((80, 29), 	(80, 29)),
iPeriodMisrEgypt :			        ((76, 40),	(81, 45)),
iPeriodPonticScythia:					((83, 55),	(87, 59)),
iPeriodVandalAfrica:					((64, 45),	(70, 48)),
iPeriodOstrogoths : 					((65, 53),	(70, 57)),
iPeriodVisigoths :					((54, 48),	(58, 62)),
iPeriodMing : 						((120, 49),	(129, 56)),
iPeriodModernGreece :					((74, 49),	(76, 54)),
iPeriodSeleucids :					((85, 47),	(89, 50)),
...
iPeriodAngloSaxons :					((56, 63),	(59, 67)),
iPeriodMughals :		            ((102, 45),	(107, 48)),
iPeriodPakistan : 					((100, 46),	(103, 49)),
iPeriodCastile :					((54, 51),	(58, 54)),
iPeriodModernSpain :					((54, 48),	(62, 54)),
iPeriodDelhi:     	        			((100, 45),  	(107, 47)),
iPeriodBuyidBaghdad :					((89, 43),	(94, 48)),
iPeriodUkraine :		 			((80, 58),	(84, 62)),
iPeriodModernBenin :					((63, 32),	(64, 33)),
iPeriodUnitedKingdom : 					((56, 63),	(59, 70)),
iPeriodGreatBritain :					((53, 62),	(59, 70)),
iPeriodArabiaMesopotamia :				((84, 46),	(90, 50)),
iPeriodHejaz :		                    ((84, 38),	(87, 43)),
iPeriodZanzibar :					((83, 19),	(85, 27)),
iPeriodByzantiumRoman :					((66, 50),	(72, 57)),
iPeriodSouthAfricaUnion :		        ((72, 11), 	(79, 16)),
}
...
iPeriodVisigoths :			[(44, 54), (45, 54), (44, 53), (45, 53)],
...
iPeriodHejaz :	[(87, 43),(87, 42),(87, 41),(86, 43)],
iPeriodCastile :	[(54, 51), (54, 52), (55, 51), (55, 52), (58, 54)],
iPeriodModernSpain :	[(55, 49), (54, 48), (54, 49), (54, 50), (55, 49), (55, 50), (54, 51), (54, 52), (55, 51), (55, 52), (62, 48)],
iPeriodBuyidBaghdad :	[(89, 43), (90, 43), (89, 44), (90, 44)],
iPeriodGreatBritain :			[(53, 65), (53, 66), (53, 67), (55, 70)],
iPeriodArabiaMesopotamia :	[(84, 46), (85, 49), (85, 50), (86, 49), (86, 50), (87, 49), (87, 50)],
iPeriodZanzibar :	[(83, 20), (83, 21), (83, 22), (83, 23), (83, 27)],
iPeriodByzantiumRoman :		[(66, 51), (66, 52), (70, 57), (71, 56), (71, 57), (72, 55), (72, 56), (72, 57)],
iPeriodSouthAfricaUnion : [(72, 14), (72, 15), (72, 16), (73, 13), (73, 14), (73, 15), (73, 16), (74, 13), (74, 14), (74, 15), (74, 16), (75, 13), (75, 14), (75, 16), (75, 15), (76, 13), (76, 14), (76, 15), (76, 16), (79, 14), (79, 15), (79, 16)]
})
...
iInca :		((27, 21),	(32, 28)),
iTimurids :	((99, 42),	(104, 50)), 
iOttomans : ((78, 51),	(87, 55)),
iRussia :	((81, 56),	(95, 75)),
iGermany :	((64, 59),	(70, 66)),
iGhorids :	((100, 45),	(106, 48)),
