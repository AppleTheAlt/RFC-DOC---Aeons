...
dNameChanges = { # TODO: this should be covered by period
	...
	iMycenae : "TXT_KEY_CIV_MGREECE_SHORT_DESC",
	iMinoa : "TXT_KEY_CIV_MGREECE_SHORT_DESC",
...
dAdjectiveChanges = {
	...
	iMinoa : "TXT_KEY_CIV_MGREECE_ADJECTIVE",
	iMycenae : "TXT_KEY_CIV_MGREECE_ADJECTIVE",
...
def specificTitle(iPlayer, lPreviousOwners=[]):
	...
	#		return "TXT_KEY_CIV_GOLDEN_HORDE"
		...
		if bCityStates and player(iPlayer).getPeriod() == -1:				
			...
			return "TXT_KEY_CIV_GREECE_CITY_STATE_OF"
