...
def getImpact(iCiv):
	...
	# Aeons - Don't do this -> It causes more conditional spawns than necessary
	# Eg. Germania never spawns in autoplay which means no HRE
