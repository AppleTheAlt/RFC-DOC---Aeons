...
// BUG - Leaderhead Relations - end
	...
	WIDGET_HELP_IMMIGRATION_DESIRE, // Aeons
...
enum EraTypes							// Exposed to Python
{
	...
	ERA_SOUTH_ASIA,
	ERA_NATIVE_AMERICA,
	ERA_AFRICA_PAGAN, // Aeons
	ERA_SUB_SAHARAN, // Aeons - For Islamic nations in Sub-Saharan Africa
};
...
#define BEGIN_WONDERS				(253) // increment if normal building (not for wonders) is added
#define BEGIN_GREAT_WONDERS			(BEGIN_WONDERS+14) // increment if a national wonder is added
...
enum BuildingTypes						// Exposed to Python
{
	...
	GREAT_SPHINX, 
	TEMPLE_OF_AMUN, // Aeons
	NURI, // Aeons
	ETEMENAKI, // Aeons
	ABU_SIMBEL, // Aeons
	GREAT_BATH, // Aeons
	TRAJANS_COLUMN, // Aeons
	CIRCUS_MAXIMUS, // Aeons
	PYRAMIDS, 
	ORACLE, 
	GREAT_WALL, 
	ISHTAR_GATE, 
...
enum SpecialistTypes			// Exposed to Python
{
	...
	SPECIALIST_TREKKER, // Aeons
	SPECIALIST_GREAT_TREKKER, // Aeons
	SPECIALIST_SLAVE,
...
enum PeriodTypes
{
	...
	PERIOD_CARTHAGE,
	PERIOD_PONTIC_SCYTHIA,
	PERIOD_UNITED_GREECE,
	...
	PERIOD_ANGLO_SAXONS,
	PERIOD_VIJAYANAGARA,
	PERIOD_VANDAL_AFRICA,
	PERIOD_VISIGOTHS,
	PERIOD_OSTROGOTHS,

	PERIOD_BYZANTINE_CONSTANTINOPLE,
	PERIOD_BYZANTIUM_ROMAN,
