...
void CyCityPythonInterface1(python::class_<CyCity>& x)
{
	...
	x
		...
		.def("immigrationDesire", &CyCity::immigrationDesire, "int (bool immigration)")
...
// BUG - Building Additional Happiness - end
		...
		.def("getDifferentReligionTradeRouteModifier", &CyCity::getDifferentReligionTradeRouteModifier, "int ()")
