...
// BUG - Leaderhead Relations - end
		...
		.value("WIDGET_HELP_IMMIGRATION_DESIRE", WIDGET_HELP_IMMIGRATION_DESIRE) // Aeons
...
// BUG - Global Warming Mod - end
	...
	python::enum_<FontSymbols>("FontSymbols")
		...
		.value("MILITARY_CHAR", MILITARY_CHAR)
		.value("IMMIGRATION_CHAR", IMMIGRATION_CHAR)
	...
	python::enum_<UnitAITypes>("UnitAITypes")
		...
		.value("UNITAI_TREKKER", UNITAI_TREKKER)
